...
public class BackupWorker {
	...
	private static final String[] TIME_ENTRIES_PROJECTION = new String[] {};
	private static final String[] CALLS_PROJECTION = new String[] {};
	private static final String[] RETURN_VISITS_PROJECTION = new String[] {};
	private static final String[] LITERATURE_PROJECTION = new String[] {};
	private static final String[] PLACEMENTS_PROJECTION = new String[] {};
	private static final String[] BIBLE_STUDIES_PROJECTION = new String[] {};
