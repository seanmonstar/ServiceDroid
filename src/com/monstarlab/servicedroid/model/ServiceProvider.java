...
public class ServiceProvider extends ContentProvider {
    ...
    static {
    	...
    	sCallProjectionMap.put(Calls.IS_STUDY, "((select count(return_visits._id) from return_visits where return_visits.call_id = calls._id and return_visits.date >= date('now', 'start of month') and return_visits.is_bible_study = 1) > 0) as 'is_study'");
